...
import qualified Uniswap                as US
...
import           Uniswap1                                (cidFile, UniswapContracts)
...
toSwapParams2 cs amtA [tnA, tnB, tnC] = US.SwapParams2 [(toCoin cs tnA, US.Amount amtA), (toCoin cs tnB, US.Amount 0), (toCoin cs tnC, US.Amount 0)]
